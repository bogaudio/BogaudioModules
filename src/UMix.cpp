...
struct UMixWidget : ModuleWidget {
	...
	UMixWidget(UMix* module) : ModuleWidget(module) {
...

		{
			...
			panel->setBackground(SVG::load(asset::plugin(pluginInstance, "res/UMix.svg")));
			addChild(panel);
		}
...
Model* modelUMix = bogaudio::createModel<UMix, UMixWidget>("Bogaudio-UMix", "UMix", "unity mixer", MIXER_TAG);
