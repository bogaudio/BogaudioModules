...
struct LmtrWidget : ModuleWidget {
	...
	LmtrWidget(Lmtr* module) : ModuleWidget(module) {
...

		{
			...
			panel->setBackground(SVG::load(asset::plugin(pluginInstance, "res/Lmtr.svg")));
			addChild(panel);
		}
...
Model* modelLmtr = bogaudio::createModel<Lmtr, LmtrWidget>("Bogaudio-Lmtr", "LMTR", "limiter", DYNAMICS_TAG);
