...
struct EightFOWidget : ModuleWidget {
	EightFOWidget(EightFO* module) : ModuleWidget(module) {
		...
		auto waveParamPosition = Vec(20.0, 167.0);
		auto samplePwmParamPosition = Vec(100.0, 162.0);
		auto offsetParamPosition = Vec(40.0, 225.0);
		auto scaleParamPosition = Vec(100.0, 225.0);
