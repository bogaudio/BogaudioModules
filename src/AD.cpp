...
struct ADWidget : ModuleWidget {
	...
	ADWidget(AD* module) : ModuleWidget(module) {
...

		{
			...
			panel->setBackground(SVG::load(assetPlugin(pluginInstance, "res/AD.svg")));
			addChild(panel);
		}
...
Model* modelAD = bogaudio::createModel<AD, ADWidget>("Bogaudio-AD", "AD", "utility envelope", ENVELOPE_GENERATOR_TAG);
