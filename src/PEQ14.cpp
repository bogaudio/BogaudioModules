...
void PEQ14::modulate() {
	...
	if (_response != response) {
		...
		for (int c = 0; c < _channels; ++c) {
			float r = _response;
			if (inputs[EF_RESPONSE_INPUT].isConnected()) {
				r *= clamp(inputs[EF_RESPONSE_INPUT].getPolyVoltage(c) / 10.f, 0.0f, 1.0f);
			}
			for (int i = 0; i < 14; ++i) {
				_efs[c][i].setSensitivity(r);
			}
		}
	}
}
...
struct PEQ14Widget : ModuleWidget {
	...
	PEQ14Widget(PEQ14* module) {
		...
		auto efResponseParamPosition = Vec(47.0, 38.0);
		auto frequencyCvParamPosition = Vec(47.0, 96.5);
		auto bandwidthParamPosition = Vec(47.0, 149.5);
		auto lpParamPosition = Vec(48.5, 198.0);
		auto hpParamPosition = Vec(48.5, 210.0);
		auto fmodParamPosition = Vec(32.5, 260.5);
		...
		auto efResponseInputPosition = Vec(9.5, 38.0);
		auto frequencyCvInputPosition = Vec(9.5, 93.5);
		auto bandwidthInputPosition = Vec(9.5, 149.5);
		...
		auto ef1OutputPosition = Vec(84.5, 325.0);
		auto ef2OutputPosition = Vec(128.5, 325.0);
		auto ef3OutputPosition = Vec(172.5, 325.0);
		auto ef4OutputPosition = Vec(216.5, 325.0);
		auto ef5OutputPosition = Vec(260.5, 325.0);
		auto ef6OutputPosition = Vec(304.5, 325.0);
		auto ef7OutputPosition = Vec(348.5, 325.0);
		auto ef8OutputPosition = Vec(392.5, 325.0);
		auto ef9OutputPosition = Vec(436.5, 325.0);
		auto ef10OutputPosition = Vec(480.5, 325.0);
		auto ef11OutputPosition = Vec(524.5, 325.0);
		auto ef12OutputPosition = Vec(568.5, 325.0);
		auto ef13OutputPosition = Vec(612.5, 325.0);
		auto ef14OutputPosition = Vec(656.5, 325.0);

		auto fmodRelativeLightPosition = Vec(28.5, 236.5);
		auto fmodFullLightPosition = Vec(28.5, 249.5);
		// end generated by svg_widgets.rb

		addParam(createParam<Knob16>(efResponseParamPosition, module, PEQ14::EF_RESPONSE_PARAM));
		...
		addInput(createInput<Port24>(efResponseInputPosition, module, PEQ14::EF_RESPONSE_INPUT));
		...
		addOutput(createOutput<Port24>(ef1OutputPosition, module, PEQ14::EF1_OUTPUT));
		addOutput(createOutput<Port24>(ef2OutputPosition, module, PEQ14::EF2_OUTPUT));
		addOutput(createOutput<Port24>(ef3OutputPosition, module, PEQ14::EF3_OUTPUT));
		addOutput(createOutput<Port24>(ef4OutputPosition, module, PEQ14::EF4_OUTPUT));
		addOutput(createOutput<Port24>(ef5OutputPosition, module, PEQ14::EF5_OUTPUT));
		addOutput(createOutput<Port24>(ef6OutputPosition, module, PEQ14::EF6_OUTPUT));
		addOutput(createOutput<Port24>(ef7OutputPosition, module, PEQ14::EF7_OUTPUT));
		addOutput(createOutput<Port24>(ef8OutputPosition, module, PEQ14::EF8_OUTPUT));
		addOutput(createOutput<Port24>(ef9OutputPosition, module, PEQ14::EF9_OUTPUT));
		addOutput(createOutput<Port24>(ef10OutputPosition, module, PEQ14::EF10_OUTPUT));
		addOutput(createOutput<Port24>(ef11OutputPosition, module, PEQ14::EF11_OUTPUT));
		addOutput(createOutput<Port24>(ef12OutputPosition, module, PEQ14::EF12_OUTPUT));
		addOutput(createOutput<Port24>(ef13OutputPosition, module, PEQ14::EF13_OUTPUT));
		addOutput(createOutput<Port24>(ef14OutputPosition, module, PEQ14::EF14_OUTPUT));
