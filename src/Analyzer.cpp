...
AnalyzerWidget::AnalyzerWidget() {
	...
	auto rangeParamPosition = Vec(100.08, 300.58);
	auto smoothParamPosition = Vec(164.08, 300.58);
	auto powerParamPosition = Vec(272.9, 302.4);

	auto signalaInputPosition = Vec(27.5, 270.0);
	auto signalbInputPosition = Vec(27.5, 323.0);

	auto signalaOutputPosition = Vec(56.5, 270.0);
