...
struct VCMWidget : DisableOutputLimitModuleWidget {
	...
	VCMWidget(VCM* module) : DisableOutputLimitModuleWidget(module) {
...

		{
			...
			panel->setBackground(SVG::load(asset::plugin(pluginInstance, "res/VCM.svg")));
			addChild(panel);
		}
...
Model* modelVCM = bogaudio::createModel<VCM, VCMWidget>("Bogaudio-VCM", "VCM",  "4-channel mixer", MIXER_TAG);
