...
struct PolyConWidget : ModuleWidget {
	...
	PolyConWidget(PolyCon* module) {
		...
		auto channel1ParamPosition = Vec(25.3, 78.2);
		auto channel2ParamPosition = Vec(25.2, 115.2);
		auto channel3ParamPosition = Vec(25.2, 152.2);
		auto channel4ParamPosition = Vec(25.2, 189.2);
		auto channel5ParamPosition = Vec(25.2, 226.2);
		auto channel6ParamPosition = Vec(25.2, 263.2);
		auto channel7ParamPosition = Vec(25.2, 300.2);
		auto channel8ParamPosition = Vec(25.2, 337.2);
		auto channel9ParamPosition = Vec(75.2, 78.2);
		auto channel10ParamPosition = Vec(75.2, 115.2);
		auto channel11ParamPosition = Vec(75.2, 152.2);
		auto channel12ParamPosition = Vec(75.2, 189.2);
		auto channel13ParamPosition = Vec(75.2, 226.2);
		auto channel14ParamPosition = Vec(75.2, 263.2);
		auto channel15ParamPosition = Vec(75.2, 300.2);
		auto channel16ParamPosition = Vec(75.2, 337.2);

		auto channelsInputPosition = Vec(54.5, 28.0);

		auto outOutputPosition = Vec(85.5, 28.0);

		auto channel1LightPosition = Vec(33.75, 100.0);
		auto channel2LightPosition = Vec(33.75, 137.0);
		auto channel3LightPosition = Vec(33.75, 174.0);
		auto channel4LightPosition = Vec(33.75, 211.0);
		auto channel5LightPosition = Vec(33.75, 248.0);
		auto channel6LightPosition = Vec(33.75, 285.0);
		auto channel7LightPosition = Vec(33.75, 322.0);
		auto channel8LightPosition = Vec(33.75, 359.0);
		auto channel9LightPosition = Vec(83.75, 100.0);
		auto channel10LightPosition = Vec(83.75, 137.0);
		auto channel11LightPosition = Vec(83.75, 174.0);
		auto channel12LightPosition = Vec(83.75, 211.0);
		auto channel13LightPosition = Vec(83.75, 248.0);
		auto channel14LightPosition = Vec(83.75, 285.0);
		auto channel15LightPosition = Vec(83.75, 322.0);
		auto channel16LightPosition = Vec(83.75, 359.0);
